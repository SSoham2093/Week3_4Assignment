# AI Agents Unleashed: Patterns, Prototypes & Production

This repository demonstrates the implementation of AI agents using the AutoGen framework, to accompany the workshop **AI Agents Unleashed: Patterns, Prototypes & Production**.

![Workshop Banner](./assets/ai-agents-unleashed.png)
